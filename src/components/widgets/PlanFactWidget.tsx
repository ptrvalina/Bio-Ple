...
export function PlanFactWidget() {
  ...
  return (
    <div className="h-full min-h-[140px] overflow-x-auto">
      <table className="w-full min-w-[480px] text-left text-sm">
        ...
        <tbody>
          {deviations.map((row) => (
            ...
            >
              <td className="py-2 pr-2 text-slate-300">{row.field}</td>
              <td className="py-2 pr-2 text-slate-300">{row.operation}</td>
              <td className="py-2 pr-2 text-slate-400">{row.plan}</td>
              <td className="py-2 pr-2 text-slate-300">{row.fact}</td>
              <td className="py-2">
                <span
